...
### [問3-5](https://github.com/hiro2001/farst/blob/main/Q3/3-5.c)

四つの整数値を読み込んでその最大値を求めて表示するプログラムを作成しなさい。

### [問3-6](https://github.com/hiro2001/farst/blob/main/Q3/3-6.c)

四つの整数値を読み込んでその最小値を求めて表示するプログラムを作成しなさい。

### [問3-7](https://github.com/hiro2001/farst/blob/main/Q3/3-7.c)

三つの整数値を読み込んで、いくつその値が等しいか表示するプログラムを作成しなさい。

### [問3-8](https://github.com/hiro2001/farst/blob/main/Q3/3-8.c)

整数値を入力させてその値によって成績（D~S）の値が出力させるプログラムを作成しなさい。
ただし0~59はD、60~70はC、70~80はB、80~90はA,90~はSである。

### [問3-9](https://github.com/hiro2001/farst/blob/main/Q3/3-9.c)

何月か入力することでその季節を表示するプログラムを作成しなさい。
